/****************************************************************************
** Meta object code from reading C++ file 'otherbutton.h'
**
...
#error "The header file 'otherbutton.h' doesn't include <QObject>."
...
void otherbutton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        otherbutton *_t = static_cast<otherbutton *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->fun(); break;
        default: ;
...
const QMetaObject otherbutton::staticMetaObject = {
    { &QPushButton::staticMetaObject, qt_meta_stringdata_otherbutton.data,
      qt_meta_data_otherbutton,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *otherbutton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_otherbutton.stringdata0))
        return static_cast<void*>(const_cast< otherbutton*>(this));
